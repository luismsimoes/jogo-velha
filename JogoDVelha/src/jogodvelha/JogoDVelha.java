...
public class JogoDVelha extends JFrame {

    JButton[] bt = new JButton[9];
    JLabel Placar = new JLabel("Placar");
    JLabel px = new JLabel("X 0");
    JLabel po = new JLabel("O 0");
    JButton renicia = new JButton("Reniciar");
    int PX = 0;
    int PO = 0;
    boolean XO = false;
    ...
    public JogoDVelha() {
        ...
        add(px);
        add(po);
        Placar.setBounds(400,40,100,30);
        px.setBounds(400,70,100,30);
        po.setBounds(450,70,100,30);
        renicia.setBounds(210,100,120,30);
            renicia.addActionListener(new java.awt.event.ActionListener() {
            @Override
